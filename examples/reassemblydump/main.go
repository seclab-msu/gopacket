...
import (
	...
	"github.com/seclab-msu/gopacket/examples/util"
	"github.com/seclab-msu/gopacket/ip4defrag"
	"github.com/seclab-msu/gopacket/layers" // pulls in all layers decoders
	"github.com/seclab-msu/gopacket/pcap"
	"github.com/seclab-msu/gopacket/reassembly"
)
...
func (t *tcpStream) Accept(tcp *layers.TCP, ci gopacket.CaptureInfo, dir reassembly.TCPFlowDirection, nextSeq reassembly.Sequence, start *bool, ac reassembly.AssemblerContext) (bool, bool) {
	// FSM
